...
@synthesize mapView, locationManager, posLocations, btnBack, btnDirection ;
...
- (void)viewDidAppear:(BOOL)animated
{
    ...
    {
        NSString * isVisible = [[[GlobalVariable sharedInstance].table_google objectAtIndex:i] valueForKey:@"isVisible"];
        if ( [isVisible isEqualToString:@"true"] ) {
            ...
            Place *currentPlace = [[Place alloc] initWithLocation:location reference:nil name:[[[GlobalVariable sharedInstance].table_google objectAtIndex:i] valueForKey:@"name"] address:[[[GlobalVariable sharedInstance].table_google objectAtIndex:i] valueForKey:@"title"]];
...
//            CLLocation *location = [[CLLocation alloc] initWithLatitude:lat longitude:lng] ;
//            
//            Place *currentPlace = [[Place alloc] initWithLocation:location reference:nil name:[[[GlobalVariable sharedInstance].resPositions objectAtIndex:i] valueForKey:@"name"] address:[[[GlobalVariable sharedInstance].resPositions objectAtIndex:i] valueForKey:@"title"]];
//            
