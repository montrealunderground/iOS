...
@protocol pARkViewControllerDelegate<NSObject>
...
@property (nonatomic, retain) IBOutlet UIImageView*         imgPromotion;
...
@property (nonatomic, strong) id <pARkViewControllerDelegate> delegate;
